...
class UVR5UI:
    ...
    def run(self):
        ...
        st.markdown("* [HP2/HP3] 保留人声：不带和声的音频选这个，对主人声保留比HP5更好HP3可能轻微漏伴奏但对主人声保留比HP2稍微好一丁点。"
                + "\n * [HP5] 仅保留主人声：带和声的音频选这个，对主人声可能有削弱。"
                + "\n * [onnx_dereverb_by_FoxJoy] 去混响、去延迟模型：对于双通道混响是最好的选择，不能去除单通道混响。"
                + "\n * [DeEcho] 去除延迟效果。Aggressive比Normal去除得更彻底，DeReverb额外去除混响，可去除单声道混响，但是对高频重的板式混响去不干净。"
                + "\n\n **去混响/去延迟最干净配置：先MDX-Net再DeEcho-Aggressive。**")
