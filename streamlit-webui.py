...
def main():
    ...
    st.write(i18n("本软件以MIT协议开源, 作者不对软件具备任何控制力, 使用软件者、传播软件导出的声音者自负全责. <br>如不认可该条款, 则不能使用或引用软件包内任何代码和文件. 详见根目录<b>LICENSE</b>."))
    st.write(i18n("中文教程文档：https://www.yuque.com/baicaigongchang1145haoyuangong/ib3g1e"))
    urv5_container = st.container(border=True)
    with urv5_container:
        if_uvr5 = st.checkbox(i18n("是否开启UVR5-WebUI"), value=False)
        uvr5_info = st.text_area(i18n("UVR5进程输出信息"))
